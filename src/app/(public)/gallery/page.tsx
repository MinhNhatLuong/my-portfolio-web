...
export default function GalleryPage() {
  ...
  const currentView =
    (searchParams.get("view") as "explore" | "albums" | "single") || "explore";
  ...
  useEffect(() => {
    ...
    if (currentView === "explore") {
      setCurrentPhotos(
        randomizedPhotos.length > 0 ? randomizedPhotos : allPhotos,
      );
          ...
          >
            {sortedAlbums.map((album) => (
              ...
              >
                ...
                <div>
                  <h3 className="text-sm md:text-xl font-bold group-hover:text-pink-500 transition-colors line-clamp-1">
                    {album.title}
                  </h3>
                  <div className="flex items-center gap-2 text-xs md:text-sm text-muted-foreground mt-1">
                    ...
                    <span className="hidden md:inline">
                      {album.photos.length} {t.photosCount}
                    </span>
                  </div>
                </div>
              </div>
